          ...
          if (data.visible == "public") {
              ...
              for (var i = 0; i < data.fileUrls.length; i++) {
                ...
                if (fileType.includes("image")) {
                  document.getElementById("file").innerHTML =
                    ...
                    "'><a href='" +
                    fileurl +
                    "'><i class='fa fa-download' style='font-size:30px;color:green'></i></a><br>";
                } else {
                  document.getElementById("file").innerHTML =
                    old +
                    "<iframe id='frame-box' alt='" +
                    fileurl +
                    "' allow-download='false' sandbox='allow-scripts' type='" +
                    fileType +
                    "'></iframe><a href='" +
                    fileurl +
                    "'><i class='fa fa-download' style='font-size:30px;color:green'></i></a><br>";
                  document
                    .getElementById("frame-box")
            ...
            if (data.author == user.displayName) {
              ...
              if (data.fileUrls && data.fileUrls.length > 0) {
                ...
                for (var i = 0; i < data.fileUrls.length; i++) {
                  ...
                  if (fileType.includes("image")) {
                    ...
                    document.getElementById("file").innerHTML =
                      old +
                      "<iframe id='frame-box' src='" +
                      fileurl +
                      "' alt='" +
                      fileurl +
                      "' allow-download='false' type='" +
                      fileType +
                      "'></iframe><a href='" +
                      fileurl +
                      "'><i class='fa fa-download' style='font-size:30px;color:green'></i></a><br>";
              ...
              document.getElementById("alert-info").innerHTML =
                "This Blog is Private You can't access it.";
            }
          } else {
            console.log("Blog Not Found");
            document.getElementById("alert-info").innerHTML =
              "The Blog Doesn't Exists Please check again.";
          }
        } else {
          if (data.visible == "public") {
            document.getElementById("title").innerHTML = data.title;
